...
with open("C:\\Users\\DELL\\OneDrive\\Desktop\\Projects\\AACPReviews\\random_forest_model.pkl", 'rb') as f:
    model = pickle.load(f)

with open("C:\\Users\\DELL\\OneDrive\\Desktop\\Projects\\AACPReviews\\tfidf_vectorizer (2).pkl", 'rb') as f:
